...
@Component({
    ...
    templateUrl: './aq-015.html',
    styleUrls: ['./aq-015.scss']
})
export class AQ_015_Component implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.events.subscribe('rdNodeDataRsp', (msg: Uint8Array)=>{
            ...
            if(partNum == this.globals.AQ_015) {
    ...
    wrNodeData_0() {
        ...
        this.wrTmo = setTimeout(()=>{
            ...
            this.rwBuf.write_uint32_LE(this.globals.AQ_015);
