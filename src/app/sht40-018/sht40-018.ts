...
@Component({
    selector: 'app-sht40-018',
    standalone: true,
    imports: [
        CommonModule
    ],
    templateUrl: './sht40-018.html',
    styleUrls: ['./sht40-018.scss']
})
export class SHT40_018_Component implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.events.subscribe('rdNodeDataRsp', (msg: Uint8Array)=>{
            ...
            if(partNum == this.globals.SHT40_018) {
    ...
    wrNodeData_0() {
        ...
        this.wrTmo = setTimeout(()=>{
            ...
            this.rwBuf.write_uint32_LE(this.globals.SHT40_018);
