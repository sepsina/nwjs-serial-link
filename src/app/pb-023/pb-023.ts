...
@Component({
    ...
    templateUrl: './pb-023.html',
    styleUrls: ['./pb-023.scss']
})
export class PB_023_Component implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.events.subscribe('rdNodeDataRsp', (msg: Uint8Array)=>{
            ...
            if(partNum == this.globals.PB_SW_023) {
    ...
    wrNodeData_0() {
        ...
        this.wrTmo = setTimeout(()=>{
            ...
            this.rwBuf.write_uint32_LE(this.globals.PB_SW_023);
